...
import { SafeAreaView, View, FlatList, Image, Dimensions, TouchableOpacity, StatusBar, StyleSheet, Text } from "react-native";
...
const MovieScreen = ({ navigation }) => {
    ...
    function moreLikeInfo() {
        const renderItem = ({ item }) => (
            <TouchableOpacity
                activeOpacity={0.9}
                style={{ ...styles.movieImageStyle, marginBottom: Sizes.fixPadding, marginHorizontal: Sizes.fixPadding - 5.0, }}
        ...
        return (
            <View style={{ marginTop: Sizes.fixPadding * 2.0 }}>
                <Text style={{ marginHorizontal: Sizes.fixPadding * 2.0, marginBottom: Sizes.fixPadding, ...Fonts.whiteColor20SemiBold }}>
                    More Like This
                </Text>
