...
import { SafeAreaView, View, FlatList, Dimensions, TouchableOpacity, StatusBar, StyleSheet, Text, ImageBackground } from "react-native";
...
const moreEpisodesList = [
    {
        ...
        episodeName: 'Hell',
        episodeNumber: 2,
        episodeDescription: 'Lorem ipsum dolor sit amet, consectetur adipscing elit. Vitae ac, eros platea elit mi, vel consectetur congue neque.',
    },
    {
        id: '2',
...
const EpisodesScreen = ({ navigation }) => {
    ...
    function moreEpisodesInfo() {
        const renderItem = ({ item }) => (
            <View style={{ marginBottom: Sizes.fixPadding * 2.0, flexDirection: 'row', alignItems: 'center', }}>
                <ImageBackground
                ...
                <View style={{ flex: 1, marginLeft: Sizes.fixPadding + 5.0 }}>
                    <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                        <Text numberOfLines={1} style={{ flex: 1, ...Fonts.whiteColor16Regular }}>
                            Episode {item.episodeNumber} : {item.episodeName}
                        </Text>
                        <Feather name="download" size={20} color={Colors.whiteColor} />
                    </View>
                    <Text numberOfLines={3} style={{ marginTop: Sizes.fixPadding - 5.0, lineHeight: 16.0, ...Fonts.whiteColor12Regular }}>
    ...
    function episodeInfo() {
        return (
            <View style={{ margin: Sizes.fixPadding * 2.0, }}>
                <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
                    <Text numberOfLines={1} style={{ flex: 1, ...Fonts.whiteColor18Medium }}>
                ...
                <Text style={{ marginTop: Sizes.fixPadding - 5.0, ...Fonts.whiteColor15Regular }}>
                    ...
                    Vitae ac, eros platea elit mi, vel consectetur congue neque.
                    Mattis nisl est euismod elementum orci integer aliquam
                    dictumst.
                </Text>
            </View>
        )
